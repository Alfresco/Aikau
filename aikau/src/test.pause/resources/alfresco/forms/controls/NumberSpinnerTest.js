...
define(["module",
   ...
   defineSuite(module, {
      ...
      "Test that the confirmation button isn't disabled": function() {
         ...
         return this.remote.findAllByCssSelector(".confirmationButton .dijitButtonDisabled")
      ...
      "Test that values honour min allowed": function() {
         ...
         return this.remote.findByCssSelector("#NS2 .dijitInputContainer input")
            .getProperty("value")
            .then(function(value) {
      ...
      "Set value below min (min only validation)": function() {
         return this.remote.findByCssSelector("#NS4 .dijitInputContainer input")
            .clearValue()
            .type("0")
            .end()
      ...
      "Set value above max (max only validation)": function() {
         return this.remote.findByCssSelector("#NS5 .dijitInputContainer input")
            .clearValue()
            .type("8")
            .end()
      ...
      "Enter a non numerical value": function() {
         return this.remote.findByCssSelector("#NS1 .dijitInputContainer input")
            .clearValue()
            .type("a")
            .end()
      ...
      "Check number with commas is valid": function() {
         return this.remote.findByCssSelector("#NS6 span.validation-message")
            .isDisplayed()
            .then(function(displayed) {
      ...
      "Empty value submits null value": function() {
         return this.remote.findByCssSelector(".alfresco-buttons-AlfButton[widgetid=\"RESET_VALUES\"] .dijitButtonNode")
            .click()
            .end()
      ...
      "Min validation with permitEmpty can be empty": function() {
         return this.remote.findByCssSelector("#NS9 input.dijitInputInner")
            .clearValue()
            .click()
            .end()
      ...
      "Max validation with permitEmpty can be empty": function() {
         return this.remote.findByCssSelector("#NS10 input.dijitInputInner")
            .clearValue()
            .click()
            .end()
