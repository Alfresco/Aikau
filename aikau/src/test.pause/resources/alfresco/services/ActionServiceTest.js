...
define(["module",
   ...
   defineSuite(module, {
      ...
      testPage: "/ActionService",

      "Selecting a document changes the selected documents appropriately": function() {
         return this.remote.findByCssSelector("[widgetid=\"DOCUMENT_SELECTED_BUTTON\"] .dijitButtonNode")
            .click()
            .end()
      ...
      "Deselecting a document changes the selected documents appropriately": function() {
         return this.remote.findByCssSelector("[widgetid=\"DOCUMENT_DESELECTED_BUTTON\"] .dijitButtonNode")
            .click()
            .end()
      ...
      "Edit offline succcess": function() {
         return this.remote.findById("EDIT_OFFLINE_SUCCESS_label")
            .click()
            .end()
      ...
      "Edit offline failure": function() {
         return this.remote.findById("EDIT_OFFLINE_FAILURE_label")
            .click()
            .end()
