...
define(["module",
   ...
   defineSuite(module, {
      ...
      testPage: "/PublishPayloadMixin",

      "Label is visible": function() {
         return this.remote.findByCssSelector("#PA_NO_TYPE .alfresco-renderers-PublishAction__label")
            .getVisibleText()
            .then(function(text) {
      ...
      "Check that no search request is used when 'useHash' is enabled": function() {
         ...
         return this.remote.findByCssSelector("#PA_NO_TYPE")
            .click()
            .end()
      ...
      "Check that CONFIGURED type payload is published (currentItem not mixed)": function() {
         ...
         return this.remote.findByCssSelector("#PA_CONFIGURED")
            .click()
            .end()
      ...
      "Check that CONFIGURED type payload is published (currentItem mixed)": function() {
         ...
         return this.remote.findByCssSelector("#PA_CONFIGURED_WITH_ITEM_MIXIN")
            .click()
            .end()
      ...
      "Check that CURRENT_ITEM type payload is published": function() {
         ...
         return this.remote.findByCssSelector("#PA_CURRENT_ITEM")
            .click()
            .end()
      ...
      "Check that PROCESS type payload is published": function() {
         ...
         return this.remote.findByCssSelector("#PA_PROCESS")
            .click()
            .end()
      ...
      "Check that PROCESS CI type payload is published": function() {
         // Check that setting the PROCESS type works...
         return this.remote.findByCssSelector("#PA_PROCESS_CI_NOT_FOUND")
            .click()
            .end()
      ...
      "Check that PROCESS INSTANCE type payload is published": function() {
         // Check that setting the PROCESS type works...
         return this.remote.findByCssSelector("#PA_PROCESS_INSTANCE_NOT_FOUND")
            .click()
            .end()
      ...
      "Check that BUILD type payload is published": function() {
         ...
         return this.remote.findByCssSelector("#PA_BUILD")
            .click()
            .end()
      ...
      "Check that PROPERTYLINK payload is published": function() {
         ...
         return this.remote.findByCssSelector("#PROPERTYLINK span.inner")
            .click()
            .end()
      ...
      "Check that DATELINK payload is published": function() {
         ...
         return this.remote.findByCssSelector("#DATELINK span.inner")
            .click()
            .end()
