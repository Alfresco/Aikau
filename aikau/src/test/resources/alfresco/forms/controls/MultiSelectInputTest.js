      ...
      registerSuite(function() {
         ...
         return {
            ...
            "Controls are fully loaded": function() {
               // Get the selectors required for this test...
               var selector1 = TestCommon.getTestSelector(MultiInputSelectSelectors, "options.loaded.state", ["MULTISELECT_1"]);
               var selector2 = TestCommon.getTestSelector(MultiInputSelectSelectors, "options.loaded.state", ["MULTISELECT_2"]);

               return browser.findAllByCssSelector(selector1)
                  .then(function(elements) {
                     assert.lengthOf(elements, 1, "First MultiSelect control not fully loaded");
                  })
                  .end()

               .findAllByCssSelector(selector2)
                  .then(function(elements) {
