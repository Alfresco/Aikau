...
define(["module",
   ...
   defineSuite(module, {
      ...
      "Check that form is initially disabled": function() {
         ...
         return this.remote.findAllByCssSelector(".alfresco-buttons-AlfButton.confirmationButton.dijitButtonDisabled")
      ...
      "Check that resolving control validation enables form submission": function() {
         ...
         return this.remote.findByCssSelector(".dijitTab:nth-child(2) .tabLabel")
            .click()
            .end()
            .findByCssSelector("#TB2 .dijitInputContainer input")
            .clearValue()
      ...
      "Check form post value": function() {
         ...
         return this.remote.findByCssSelector(".alfresco-buttons-AlfButton.confirmationButton > span")
            .click()
            .end()
      ...
      "Check requirement rule disables form": function() {
         ...
         return this.remote.findByCssSelector(".dijitTab:nth-child(1) .tabLabel")
            .click()
            .end()
