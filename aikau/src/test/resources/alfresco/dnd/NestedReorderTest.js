...
define(["module",
   ...
   defineSuite(module, {
      ...
      testPage: "/nested-reorder-dnd",

      "Check that only 3 items are shown on the palette": function() {
         // ...as all the others have been used...
         return this.remote.findAllByCssSelector("#DRAG_PALETTE1 .dojoDndItem")
      ...
      "Move a deep nested item down a place": function() {
         return this.remote.findByCssSelector(".middleTestItemWrapper:nth-child(1) .innerTestItemWrapper:nth-child(1) .down")
            .click()
            .end()
            .clearLog()
      ...
      "Delete a deep nested item": function() {
         return this.remote.findByCssSelector(".middleTestItemWrapper:nth-child(1) .innerTestItemWrapper:nth-child(1) .delete")
            .click()
            .end()
            .clearLog()
            .findByCssSelector(".confirmationButton > span")
      ...
      "Re-order deep nested item using buttons": function() {
         return this.remote.findByCssSelector(".middleTestItemWrapper:nth-child(2) .innerTestItemWrapper:nth-child(4) .up")
            .click()
            .end()
            .clearLog()
            .findByCssSelector(".confirmationButton > span")
      ...
      "Re-order middle nested item using buttons": function() {
         return this.remote.findByCssSelector(".middleTestItemWrapper:nth-child(1) > .actions > .down")
            .click()
            .end()
            .clearLog()
            .findByCssSelector(".confirmationButton > span")
      ...
      "Delete middle nested item": function() {
         return this.remote.findByCssSelector(".middleTestItemWrapper:nth-child(1) > .actions > .delete")
            .click()
            .end()
            .clearLog()
            .findByCssSelector(".confirmationButton > span")
