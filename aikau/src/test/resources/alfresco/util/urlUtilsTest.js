      ...
      registerSuite(function() {
         ...
         return {
            ...
            "convertUrl() handles urlTypes.PAGE_RELATIVE": function() {
               return browser.executeAsync(convertUrl, ["/hello", "PAGE_RELATIVE"])
            ...
            "convertUrl() handles urlTypes.REQUIRE_PATH": function() {
               return browser.executeAsync(convertUrl, ["alfresco/html/css/Image.css", "REQUIRE_PATH"])
                  .then(function(convertedUrl) {
            ...
            "convertUrl() handles urlTypes.FULL_PATH": function() {
               ...
               return browser.executeAsync(convertUrl, [testUrl, "FULL_PATH"])
                  .then(function(convertedUrl) {
            ...
            "convertUrl() handles urlTypes.HASH": function() {
               return browser.executeAsync(convertUrl, ["#foo=bar&wibble=hi", "HASH"])
                  .then(function(convertedUrl) {
