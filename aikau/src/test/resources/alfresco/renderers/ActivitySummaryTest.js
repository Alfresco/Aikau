...
define(["intern!object",
   ...
   function(registerSuite, assert, require, TestCommon) {
      ...
      var browser,
         renderedValues = [
            "Andy Healey previewed document P9111608.jpg in alfresco-uk-photo",
            "Tom Page liked document boats.jpg in alfresco-uk-photo",
            "Pete Philips updated wiki page Security_Blog in security",
            "Andy Healey added document black sand beach, iceland.jpg in alfresco-uk-photo",
            "Lambert Nguyen deleted document 401K_InfoSheet_2015.pdf in hr",
            "Paul brodner downloaded document Pentest Secure Code Workshop 2013.pdf in security",
            "David Webster role changed to Contributor in alfresco-uk-photo",
            "David Draper updated document Aikau Code Coverage Test Results Graph.png in aikau",
