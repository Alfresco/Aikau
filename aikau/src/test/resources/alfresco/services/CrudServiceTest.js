...
define(["module",
   ...
   defineSuite(module, {
      name: "CrudService",
      testPage: "/CrudService",

      "Valid DELETE call succeeds": function() {
         return this.remote.findById("DELETE_SUCCESS_BUTTON")
            .click()
            .end()
      ...
      "Invalid DELETE call fails": function() {
         return this.remote.findById("DELETE_FAILURE_BUTTON")
            .click()
            .end()
      ...
      "Failed DELETE displays failure message": function() {
         return this.remote.findByCssSelector("#NOTIFICATION_PROMPT .dialog-body")
      ...
      "Valid UPDATE call succeeds": function() {
         return closeAllDialogs(this.remote)
            .then(() => {
               return this.remote.findById("UPDATE_SUCCESS_BUTTON")
                  .click()
                  .end()
      ...
      "Invalid UPDATE call fails": function() {
         return this.remote.findById("UPDATE_FAILURE_BUTTON")
            .click()
            .end()
      ...
      "Valid CREATE call succeeds": function() {
         return closeAllDialogs(this.remote)
            .then(() => {
               return this.remote.findById("CREATE_SUCCESS_BUTTON")
                  .click()
                  .end()
      ...
      "Invalid CREATE call fails": function() {
         return this.remote.findById("CREATE_FAILURE_BUTTON")
            .click()
            .end()
      ...
      "GET ALL success": function() {
         return closeAllDialogs(this.remote)
            .then(() => {
               return this.remote.findById("GET_ALL_DEFAULT_CACHE_BUTTON")
                  .click()
                  .end()
      ...
      "GET ALL with prevent cache option success": function() {
         return this.remote.findById("GET_ALL_PREVENT_CACHE_BUTTON")
            .click()
            .end()
      ...
      "Check URI encoding": function() {
         return this.remote.findById("URL_ENCODING_REQUIRED_BUTTON")
            .clearXhrLog()
            .click()
            .end()
      ...
      "Scoped create": function() {
         return this.remote.findById("SCOPED_CREATE_label")
            .click()
            .end()
      ...
      "Scoped delete": function() {
         return this.remote.findById("SCOPED_DELETE_label")
            .click()
            .end()
      ...
      "Scoped delete with confirmation": function() {
         return this.remote.findById("SCOPED_DELETE_WITH_CONFIRMATION_label")
            .click()
            .end()
      ...
      "Scoped Update": function() {
         return this.remote.findById("SCOPED_UPDATE_label")
            .click()
            .end()
