...
define(["module",
        ...
        function(module, defineSuite, expect, assert, TestCommon, keys) {
   ...
   defineSuite(module, {
      ...
      testPage: "/AlfTabContainer",

      "Check the tab container is present": function() {
         return this.remote.findByCssSelector(selectors.tc1.container)
      ...
      "Check the correct number of tabs is present": function() {
         return this.remote.findAllByCssSelector(selectors.tc1.tabs)
            .then(function(tabs) {
      ...
      "Check the correct number of panels is present": function() {
         return this.remote.findAllByCssSelector(selectors.tc1.panels)
      ...
      "Visible panel not rendered": function() {
         return this.remote.findByCssSelector(selectors.tc1.visiblePanel)
            .then(function() {}, function() {
      ...
      "Check the correct number of hidden panels is present": function() {
         return this.remote.findAllByCssSelector(selectors.tc1.hiddenPanels)
            .then(function(panels) {
      ...
      "Checking 3rd panel is visible": function() {
         return this.remote.findByCssSelector(selectors.tc1.thirdPanel)
            .getAttribute("class")
      ...
      "Checking 11th panel is hidden": function() {
         return this.remote.findByCssSelector(selectors.tc1.eleventhPanel)
            .getAttribute("class")
            .then(function(currClasses) {
      ...
      "Select 11th tab, check 3rd panel is hidden": function() {
         return this.remote.findByCssSelector(selectors.tc1.eleventhTab)
            .click()
            .end()
   ...
   defineSuite(module, {
      ...
      "Checking 4th is hidden": function() {
         return this.remote.findByCssSelector(selectors.tc1.fourthPanel)
            .getAttribute("class")
            .then(function(currClasses) {
      ...
      "Checking 3rd panel is visible (2)": function() {
         return this.remote.pressKeys(keys.ARROW_LEFT)
   ...
   defineSuite(module, {
      ...
      "Checking 3rd panel is visible": function() {
         return this.remote.findById("Logo3")
            .isDisplayed()
      ...
      "Checking 1st panel is hidden after external selection by index": function() {
         return this.remote.findById("Logo1")
            .isDisplayed()
            .then(function(displayed) {
      ...
      "Checking 2nd panel is hidden after external selection by title": function() {
         return this.remote.findById("Logo2")
            .isDisplayed()
            .then(function(displayed) {
   ...
   defineSuite(module, {
      ...
      testPage: "/AlfTabContainerUseCase",
      ...
      "Checking new panel is selected": function() {
         return this.remote.findByCssSelector(selectors.tc1.secondPanel)
            .isDisplayed()
            .then(function(displayed) {
      ...
      "Check that the new panel has rendered content correctly": function() {
         return this.remote.findByCssSelector(selectors.tc1.secondPanel + " .alfresco-html-Label")
            .getVisibleText()
            .then(function(text) {
      ...
      "Check that the form control in the new panel has rendered correctly": function() {
         return this.remote.findByCssSelector("#SELECT_FOR_One .label")
            .getVisibleText()
            .then(function(text) {
               assert.equal(text, "Select...", "The form control was not displayed correctly");
            });
   ...
   defineSuite(module, {
      ...
      testPage: "/AlfTabContainerUseCase2",
