 ...
 * @author Dave Draper
 * @deprecated Since 1.0.4 - Use [alfresco/lists/views/layouts/HeaderCell]{@link module:alfresco/lists/views/layouts/HeaderCell} instead.
 */
define(["dojo/_base/declare",
        "alfresco/lists/views/layouts/HeaderCell"], 
        function(declare, HeaderCell) {
