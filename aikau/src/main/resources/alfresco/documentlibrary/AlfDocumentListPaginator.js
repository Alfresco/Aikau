...
/**
 * @module alfresco/documentlibrary/AlfDocumentListPaginator
...
define(["dojo/_base/declare",
   ...
   return declare([AlfMenuBar, _AlfDocumentListTopicMixin], {
       ...
       */
      postMixInProperties: function alfresco_documentlibrary_AlfDocumentListPaginator__postMixInProperties() {
         ...
         this.alfSubscribe(this.pageBackTopic, lang.hitch(this, "onPageBack"));
         this.alfSubscribe(this.pageForwardTopic, lang.hitch(this, "onPageForward"));
      },
       ...
       */
      onPageBack: function alfresco_documentlibrary_AlfDocumentListPaginator__onPageBack(payload) {
         this.currentPage--;
       ...
       * @fires pageSelectionTopic
       */
      onPageForward: function alfresco_documentlibrary_AlfDocumentListPaginator__onPageForward(payload) {
         this.currentPage++;
         this.alfPublish(this.pageSelectionTopic, {
            value: this.currentPage
         });
         ...
         this.widgets = [
            {
               ...
               config: {
                  ...
                  label: this.message("alf-documentlist-paginator.back.label"),
