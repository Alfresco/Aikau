 ...
 * [menu item]{@link module:alfresco/menus/AlfMenuItem} for the "Move To" action.</p>
 * 
 * @module alfresco/renderers/actions/MoveTo
 * @author Martin Doyle
 * @since 1.0.36
 */
define(["alfresco/core/topics",
   ...
   return  {
      id: "MOVE_TO",
      label: "actions.move-to",
      iconClass: "alf-doclib-action alf-move-to-icon",
      ...
      renderFilters: [
         // User must be able to delete the item
         {
            renderFilter: [
               {
