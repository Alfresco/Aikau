...
/**
 * This module is in BETA. Outstanding work:
 * - blocking (or adding) of additional uploads once an upload has commenced
 * - controlling when the "OK" and "Cancel" buttons are displayed
 * - providing an extension point for post upload processing
 * 
...
define(["dojo/_base/declare",
   ...
   return declare([_WidgetBase, AlfCore, CoreXhr], {
       ...
       */
      i18nRequirements: [{i18nFile: "./i18n/AlfUpload.properties"}],
       ...
       * @instance
       */
      reset: function alfresco_upload_AlfUpload__reset() {
       ...
       * @instance
       */
      constructor: function alfresco_upload_AlfUpload__constructor(args) {
         lang.mixin(this, args);
         this.reset();
         this.alfSubscribe(this._ALF_UPLOAD_TOPIC, lang.hitch(this, "onUploadRequest"));
      },
       ...
       */
      validateRequestedFiles: function alfresco_upload_AlfUpload__validateRequestedFiles(files) {
       ...
       */
      addInvalidFile: function alfresco_upload_AlfUpload__addInvalidFile(file) {
         // Add the file to the displayed list of failed files
         this.alfLog("log", "Adding invalid file: ", file, this);
         if (this.uploadDisplayWidget != null && typeof this.uploadDisplayWidget.addFailedFile === "function")
         {
       ...
       */
      addFileForUpload: function alfresco_upload_AlfUpload__startFileUpload(file) {
       ...
       */
      startFileUploads: function alfresco_upload_AlfUpload__startFileUploads(targetData) {
       ...
       */
      constructUploadData: function alfresco_upload_AlfUpload__constructUploadData(file, fileName, targetData) {
       ...
       */
      startFileUpload: function alfresco_upload_AlfUpload__startFileUpload(fileInfo)
      {
       ...
       */
      uploadProgressListener: function alfresco_upload_AlfUpload__uploadProgressListener(fileId, evt) {
         ...
         if (evt.lengthComputable)
         {
            try
            {
               ...
               if (this.uploadDisplayWidget != null && typeof this.uploadDisplayWidget.updateUploadProgress === "function")
               {
       ...
       */
      updateAggregateProgress: function alfresco_upload_AlfUpload__updateAggregateProgress(fileInfo) {

         // Update the aggregate progress of all the files uploaded...
         if (this.uploadDisplayWidget != null && typeof this.uploadDisplayWidget.updateAggregateProgress === "function")
         {
       ...
       */
      successListener: function alfresco_upload_AlfUpload__successListener(fileId, evt) {
         try
         {
            ...
            if (fileInfo.request.readyState != 4)
            {
               ...
               var _this = this;
               fileInfo.request.onreadystatechange = function alfresco_upload_AlfUpload__onreadystatechange()
               {
                  if (fileInfo.request.readyState == 4)
                  {
     ...
     /**
      ...
      processUploadCompletion: function alfresco_upload_AlfUpload__processUploadCompletion(fileId, evt) {
         ...
         if (fileInfo.request.status == "200")
         {
            ...
            if (this.uploadDisplayWidget != null && typeof this.uploadDisplayWidget.handleCompletedUpload === "function")
            {
       ...
       */
      failureListener: function alfresco_upload_AlfUpload__failureListener(fileId, evt) {
         try
         {
            var fileInfo = this.fileStore[fileId];
      ...
      processUploadFailure: function alfresco_upload_AlfUpload__processUploadFailure(fileId, evt) {
         ...
         if (this.uploadDisplayWidget != null && typeof this.uploadDisplayWidget.handleFailedUpload === "function")
         {
       ...
       */
      createProgressDialogTitle: function alfresco_upload_AlfUpload__createProgressDialogTitle() {
      ...
      /**
       * Creates the dialog for displaying upload progress.
       * 
       * @instance
       */
      postCreate: function alfresco_upload_AlfUpload__postCreate() {
         // Set up template?
       ...
       */
      getUploadDisplayWidget: function alfresco_upload_AlfUpload() {
         if (this.progressDialog != null && this.progressDialog.uploadDisplayWidget != null)
         {
       ...
       */
      onProgressDialogOkClick: function alfresco_upload_AlfUpload__onProgressDialogOkClick(payload) {
         ...
         this.reset();
         if (this.uploadDisplayWidget != null && typeof this.uploadDisplayWidget.reset === "function")
         {
         ...
         if (this.currentResponseTopic != null)
         {
       ...
       * @param {object} payload The details of the button click.
       */
      onProgressDialogCancelClick: function alfresco_upload_AlfUpload__onProgressDialogCancelClick(payload) {
