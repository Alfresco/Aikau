        ...
        members.modules.forEach(function(m) {
            if ( !hasOwnProp.call(seen, m.longname) ) {
                var nameParts = m.name.split("/"),
                   shortName = nameParts.pop(),
                   component = nameParts.join("/");

                if (nameParts.join("/") !== lastHeading) {
                   nav += (lastHeading === "") ? "" : "</ul>";
                   nav +="<h4>" + component + "</h4><ul>";
                   lastHeading = component;
                }

                nav += '<li>'+linkto(m.longname, shortName)+'</li>';
            }
